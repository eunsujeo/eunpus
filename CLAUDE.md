...
- **현재 상태**: 38 stage 진행. 5 priority domain (Workspace / Identity / Governance / Mobile / Security) deep ingest. 신규 entity 0 streak 28 stage 연속.
...
## 9. 작업 우선순위 (현재, Stage 35 prep)

1. Plan 1 ✅ — root index.md
2. Plan 2 ✅ — 이 파일 (CLAUDE.md)
3. Plan 3 — Lint Stage 35 (gap inventory)
4. Plan 4 — Open-Q Status 표기 통일
5. Plan 5 — YAML frontmatter (optional)

## 10. 진행 중인 docs-site 리뷰

`wiki-docs.pages.dev` 의 27 페이지를 페이지별로 리뷰하며 일반 독자가 읽기 쉽도록 정정 중. 다음 차례와 작업 절차는 [NEXT.md](NEXT.md) 에 self-contained 로 정리되어 있음 — 새 세션에서도 그 문서만 보고 이어갈 수 있다. 적용할 패턴 집합은 [.claude/skills/doc-author/](.claude/skills/doc-author/) skill.
