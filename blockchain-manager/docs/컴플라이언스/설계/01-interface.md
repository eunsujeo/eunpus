...
|---|---|---|---|---|
| `NOT_REQUIRED` | 적용 규정상 VASP 간 정보 교환 대상이 아님. 판정에 사용한 시행일·관할권·상대 유형·정책 버전을 기록 | `BELOW_THRESHOLD`·`NON_CUSTODIAL`은 벤더 원어로만 보존하고 자동 매핑하지 않음 | 국내 VASP는 2027-02-19부터 금액 제외 없음 | 국내 VASP는 2027-02-19부터 금액 제외 없음 |
