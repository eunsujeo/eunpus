...
| 시스템 | 배포 단위 | 무엇 | 상세 |
|---|---|---|---|
| DAW-CORE | Service 백엔드 | 고객 런타임 — 계정·주소·입금·출금·잔액 | [블록체인매니저 0장](../../블록체인매니저/설계/00-cast.md) |
| DAW-CORE | Admin 백엔드 | 운영·거버넌스 — Service 와 물리 분리(배포·권한·감사 경계) | [블록체인매니저 0장](../../블록체인매니저/설계/00-cast.md) |
...
| 컴플라이언스 | 컴플라이언스 서비스 | 규제 확인 전담 — 라우터 + 솔루션 어댑터. 트래블룰 게이트가 첫 모듈. 1차 대조(사전 검증 기록 — 컴플라이언스 DB)는 이 서비스, 귀속·가용 전이는 DAW-CORE | [트래블룰 8장](../../트래블룰/설계/08-gate-port.md) · [12장](../../트래블룰/설계/12-physical-layout.md) |
...
| 저장소 | 소유 | 담는 진실 |
|---|---|---|
| DAW-CORE DB | DAW-CORE | 회계 진실 — 고객 원장·귀속·출금 지시 상태 · VASP 마스터(거래 허용·정체). 벤더가 바뀌어도 남는다 |
