...
2026-08-12에 전달받은 [VerifyVASP 담당자 회의록](../../../sources/travel-rule-solutions/verifyvasp-meeting/2026-08-12__meeting-notes.md)은 직접 연동의 운영 조건을 세 가지 보강한다. 공식 API 명세가 아니라 벤더 발언이므로 계약·운영정책으로 확정한 뒤 적용한다.
