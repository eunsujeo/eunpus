---
title: 10. 해외 망 지형 — 주요 망·거래소·Notabene 도달 여부
status: To Do
---
...
- **Notabene** — 망이 아니라 프로토콜 비종속 **게이트웨이**. TRP·OpenVASP·TRUST·TRNow·Sygna·TRISA·Shyft·Netki 를 브릿지한다. **VerifyVASP 는 게이트웨이 지원 대상이나 라이브 여부가 공개 자료로 불확실**하다(검증은 9장).
