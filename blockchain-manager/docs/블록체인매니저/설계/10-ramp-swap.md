...
충전·환전·스왑도 이 DAW-CORE의 흐름이다 — 새 매니저 기능이 아니라 1~8장의 입금·출금이 사전 민팅 재고 풀·델타 원장과 만나 조립된 것.
...
이 배치 전송의 gas 는 **Universal Gasless 로 대납**한다. 채택 범위와 도입 요건은 [블록체인 매니저 가스 대납 적용](../가스대납/00-overview.md)을 따른다.
