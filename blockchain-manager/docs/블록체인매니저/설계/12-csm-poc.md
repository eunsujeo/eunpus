...
| 정합 항목 | 합의할 것 | 관련 |
|---|---|---|
| 상태 — [4장 "공통 상태 다섯 (TxStatus)" 기준](04-detect-confirm.md#공통-상태-다섯-txstatus-기준) 그대로 합의 | 다섯 상태의 뜻·보장하는 subStatus 값·세 축(status/subStatus/networkStatus) 분담이 기준 표에 있다 — boost 는 매니저가 원 txId 로 접으므로 계약에 없다(6장) | 4·5·6장 |
