...
[Fireblocks 담당자의 2026-08-18 답변](../../../sources/fireblocks-support/2026-08-18__gasless-relay-billing-conversation.md)에 따르면 Fireblocks Relay에서 온체인 Revert는 네트워크가 가스를 소비했으므로 청구되고, Policy·검증 단계에서 Broadcast 전에 차단된 요청은 네트워크 비용이 발생하지 않는다.
