...
[보관된 Fireblocks 공식 Sweep 원문](../../../../sources/fireblocks/markdown/2026-07-03__developers-fireblocks-com__sweep-funds-omnibus.md)은 Universal Gasless가 ERC-20·ERC-721·ERC-1155 Sweep을 지원하지만 네이티브 ETH 전송은 Relay하지 않는다고 구분한다. 네이티브 자산을 취급하는 서비스는 Gasless만으로 기본 자산 보유를 완전히 제거했다고 판단하면 안 된다.
