...
**A.** 든다. 우리 물량(목록 ~120/분·단건 ~600/분)이 한도(1,000·1,500)에 여유 있게 든다고 확인받았다.
...
**Q.** REJECTED·BLOCKED 가 벤더 쪽에서 최종 상태인가?
**A.** 미확인. 되살아날 수 있으면 저빈도 재확인을 유지해야 하고, 최종이면 관찰을 접고 운영 절차만 남긴다 — 동결 닫기 규칙이 여기 달려 있다.
