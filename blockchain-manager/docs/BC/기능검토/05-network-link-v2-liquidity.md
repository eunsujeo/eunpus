...
| FB-SUP-001 | [Fireblocks 담당자 기술 질의응답](../../../sources/fireblocks-support/2026-08-12__network-link-v2-liquidity-conversation.md) | LP 선행 연동·거래쌍 조건, 제공자 유형, Swap API, createTransaction, 외부 제공자 후보 제안, 미답변 질문 |
| FB-SUP-002 | [Private LP 후속 질의응답](../../../sources/fireblocks-support/2026-08-12__network-link-v2-private-lp-continuation.md) | KRWK 발행업체 Aggregator 제안 구조, 기관 고객 이중 KYB·API key 접근 제한, 최종 미답변 질문 |
