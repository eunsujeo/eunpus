...
sweep 이 끝난 뒤 Gateway 입금이 붙는 2단 구조다. **점선은 아직 안 정했다** — 인출을 출금 풀로 바로 받는 것이 안이고, 옴니버스로 받아 거기서 나누는 선택지가 남아 있다([우리 구조에 걸리는 것](04-usdc-gateway-fit.md)).
...
| 쓸모 | 출금 풀 재고 보충 | [브릿지 — 문제](../../블록체인매니저/브릿지/01-problem.md) 브릿지교환의 상대편 재고를 체인 무관으로 유지 |
