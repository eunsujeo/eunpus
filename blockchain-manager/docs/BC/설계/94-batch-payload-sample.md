...
- **`networkFee` 는 확정 전후로 값이 바뀐다.** value 0.001 을 실은 호출을 따로 내서 재보니 `CONFIRMING` 때 `0.000087025325530572`, `COMPLETED` 때 `0.000045943608266259` 였다. 수수료를 원장에 남기려면 확정 후 값을 써야 한다.
