        ...
        "parameters": [
          {
            ...
            "description": "벤더 표기로 찾는다 — 대소문자를 가리지 않는다. 우리 토큰 코드와 다를 수 있다",
            "example": "USDC"
          },
          {
            "name": "network",
    ...
    "schemas": {
      ...
      "AssetCandidate": {
        ...
        "properties": {
          ...
          "symbol": {
            "type": "string",
            "description": "벤더가 이 자산에 붙인 표기 — 우리 토큰 코드(`token`)와 다를 수 있다",
            "example": "USDC"
          },
          "displayName": {
            "oneOf": [
      ...
      "RegisterAssetMappingRequest": {
        ...
        "properties": {
          ...
          "token": {
            "type": "string",
            "description": "우리 토큰 코드 — 여기서 정하고, 이후 모든 계약에서 이 값을 쓴다",
            "example": "USDC"
          },
          "contractAddress": {
            "oneOf": [
