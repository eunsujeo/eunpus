  ...
  "components": {
    "parameters": {
      ...
      "Asset": {
        ...
        "description": "자산 식별 (체인 × 토큰) — DB `tkn_smbl`(16자) 대응. 벤더 assetId 와의 변환은 매니저 내부 몫.",
        "example": "ETH_USDC"
      }
    },
    "schemas": {
      ...
      "Account": {
        ...
        "properties": {
          ...
          "ref": {
            "type": "string",
            "maxLength": 64,
            "description": "우리 참조 키 — DAW-CORE 계정 ID 그대로. 접두사는 붙지 않는다",
            "example": "000123"
          },
          "accountId": {
            "type": "string",
      ...
      "TxStatus": {
        ...
        "description": "공통 상태 다섯 — 매니저 ↔ DAW-CORE 계약 어휘 (벤더 원어와 구분).",
        "x-enumDescriptions": {
          "SUBMITTED": "제출 — 체인 미등장",
      ...
      "CreateAccountRequest": {
        ...
        "properties": {
          ...
          "ref": {
            "type": "string",
            "maxLength": 64,
            "description": "우리 참조 키 — DAW-CORE 계정 ID 그대로. 접두사가 붙지 않으므로 `accountType` 과 짝이어야 유일하다. 자리수·형식은 코어 계정 ID 규칙을 따른다. 초과 시 `400 VALIDATION_FAILED`.",
            "example": "000123"
          }
        }
      },
      ...
      "BulkAddressRequest": {
        ...
        "properties": {
          "items": {
            ...
            "minItems": 1,
            "maxItems": 100,
            "description": "발급 대상 1~100건. 빈 배열·초과는 `400 VALIDATION_FAILED`. 같은 조합이 두 번 들어오면 발급은 한 번만 하고 두 항목에 같은 결과를 담는다.",
            "items": {
              "$ref": "#/components/schemas/BulkAddressItem"
            }
          }
        }
      },
      "BulkAddressResult": {
        "type": "object",
        "description": "항목 하나의 결과 — 성공이면 `address`, 실패면 `error` 가 채워진다 (둘 중 하나만).",
        "required": [
          "accountId",
          "asset"
        ],
      ...
      "BulkAddressResponse": {
        ...
        "properties": {
          "data": {
            "type": "array",
            "description": "요청과 같은 순서의 항목별 결과",
            "items": {
              "$ref": "#/components/schemas/BulkAddressResult"
            }
          },
          "meta": {
            "$ref": "#/components/schemas/Meta"
