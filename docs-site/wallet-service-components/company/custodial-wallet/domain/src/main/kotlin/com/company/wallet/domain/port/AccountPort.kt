...
interface AccountPort {
     ...
     * 첫 식별자부터 발급은 [DepositAddressIssuanceCapability] — Canton 도 구현(주소 PartyId 고정 + 새 memo 채번, 가이드 Stage 81).
 ...
 * Canton 도 구현 — 주소(PartyId) 고정 + 새 memo 채번이 곧 발급(FB 의 tag/memo 형 모델과 동형, Stage 81). NodeWallet 은 지갑당 주소 1개라 부재.
